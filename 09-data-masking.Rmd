# Tidy evaluation and programming with dplyr
...
Note: the tidyverse uses the term 'data masking' to describe this behavior. This is unrelated to masking in the sense of blinding analysts to treatment assignment, which is discussed in the [Reproducibility](03-reproducibility.html) chapter.
