...
args = parser.parse_args("0-Config.R".split())
args_dict = vars(args)
...
for filename in args_dict["filenames"]:
  ...
  if args_dict["parallel"]: system_call = "nohup" + " " + system_call + " &"
...
logDirPrefix = "/home/kaiserData/logs/"
