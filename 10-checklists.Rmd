...
- Have you completed the relevant reporting checklist, if applicable?  (add links)
...
- Does the text avoid describing results with the word "significant", which can easily be confused with statistical significance? 
...
- Are the colors used colorblind friendly? See a colorblind-friendly palette [here](http://www.cookbook-r.com/Graphs/Colors_(ggplot2)/#a-colorblind-friendly-palette).
