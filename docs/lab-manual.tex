...
\author{}
\date{\vspace{-2.5em}Updated: 2022-06-29}
...
You may also get an error message because Sherlock has some package dependencies as ``modules.'' These modules should be loaded on the command line or in the sbatch script before trying to install the package. For example, the lme4 package requires nloptr, and you may encounter problems installing nloptr and its dependencies, e.g.~cmake, normally. Instead, try loading the following modules on the command line before opening R or include them in the sbatch script before submitting your job:
