...
\author{}
\date{\vspace{-2.5em}Updated: 2024-10-14}
...
Commenting your code is an important part of reproducibility and helps document your code for the future. When things change or break, you'll be thankful for comments. There's no need to comment excessively or unnecessarily, but a comment describing what a large or complex chunk of code does is always helpful. See \href{https://github.com/kmishra9/Flu-Absenteeism/blob/master/Master\textquotesingle{}s\%20Thesis\%20-\%20Spatial\%20Epidemiology\%20of\%20Influenza/1b\%20-\%20Map-Management.R}{this file} for an example of how to comment your code and notice that comments are always in the form of:
...
\hypertarget{repeating-analyses-with-different-variations}{%
...
\hypertarget{parallel-processing-with-parallel-and-future-packages}{%
...
\hypertarget{reproducible-environments}{%
\chapter{Reproducible Environments}\label{reproducible-environments}}

by Anna Nguyen

\hypertarget{package-version-control-with-renv}{%
...
\hypertarget{implementing-renv-in-projects}{%
...
\hypertarget{using-projects-with-renv}{%
...
\hypertarget{geographic-information}{%
...
\hypertarget{a-single-set-of-public-ids-for-each-study}{%
...
\hypertarget{create-a-data-repository}{%
...
\hypertarget{steps-for-creating-an-open-science-framework-osf-repository}{%
...
\hypertarget{edit-and-test-analysis-scripts}{%
...
\hypertarget{create-a-public-github-page-for-public-scripts}{%
\section{Create a public GitHub page for public scripts}\label{create-a-public-github-page-for-public-scripts}}

At minimum, we should include all of the scripts required to run the analyses. \textbf{IMPORTANT}: ensure you have taken a snapshot and saved your computing environment using the \texttt{renv} package (\protect\hyperlink{renv}{\texttt{renv}}).
...
\hypertarget{folder-permissions}{%
...
\hypertarget{professional-advice}{%
...
\hypertarget{ethics-and-global-health-research}{%
