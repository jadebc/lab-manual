...
We use the Tidyverse as our default R dialect. For most of our work that does not involve very large datasets, Tidyverse packages provide clear, readable syntax that makes code easier to review and reproduce. For large data pipelines, `data.table` is a performant alternative. If you encounter base R patterns in legacy code or external packages, the reference table below maps common translations. Hadley Wickham's [R for Data Science](https://r4ds.had.co.nz/) is a good resource for learning the Tidyverse ecosystem.
