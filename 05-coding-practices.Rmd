...
Thus, **when the input lists are of different lengths, maybe the best practice is to use `lapply()` to each of the lists and then combine them with `append()` or with `bind_rows()` if the output is a list of data frames.**
