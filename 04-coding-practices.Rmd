...
### Dropbox
Follow the instructions at [this link](https://github.com/karthik/rdrop2) to use the `rdrop2` package. Similar to the `boxr` package, you need to complete the setup steps and authenticate before reading and writing from Dropbox.
